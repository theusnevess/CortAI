...
- file: `tests/agents/trend_analysis/test_trend_analysis_agent_phase2_unittest.py`
...
### 15.2 Block 3 smoke
- file: `tests/runtime/pipeline/test_phase2_block3_smoke_unittest.py`
...
- file: `tests/agents/strategy/test_strategy_agent_phase2_unittest.py`
- file: `tests/agents/strategy/test_strategy_agent_evolution_v2_0_integration_unittest.py`
...
- file: `tests/validation/tools/validate_visual_query_pipeline.py`
...
- `tests/validation/tools/validate_visual_query_pipeline.py`
