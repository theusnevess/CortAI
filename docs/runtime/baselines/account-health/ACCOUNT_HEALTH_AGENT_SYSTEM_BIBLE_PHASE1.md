...
- returned payload has:
  ...
  - no `creative_pack`
  - no `video_qc`
- `tests/runtime/pipeline/test_phase2_block2_smoke_unittest.py` explicitly verifies this
...
- `tests/gates/system/run_pipeline_v2_full_system_certification.py`
- `tests/gates/system/run_pipeline_multiagent_heavy_audit_gate.py`
