...
- `tests/gates/agents/editor/run_editor_agent_full_validation.py`
- `tests/gates/agents/editor/run_editor_expression_validation.py`
- `tests/gates/agents/editor/run_editor_punch_and_variation_validation.py`
- `tests/gates/agents/editor/run_editor_final_parity_validation.py`
