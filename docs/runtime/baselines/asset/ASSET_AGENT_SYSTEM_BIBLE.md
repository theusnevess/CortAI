...
Documented/expected by `docs/runtime/baselines/asset/ASSET_AGENT_DECISION_STANDARD.md` but not present as first-class persisted fields in `AssetPlan`:
...
- outcome: `docs/runtime/baselines/asset/ASSET_AGENT_DECISION_STANDARD.md` and gate doc created
