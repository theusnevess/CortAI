# CORTAI Architecture And State

Canonical consolidated entrypoint for current runtime architecture and master state.
...
## Source: `docs/runtime/architecture/CORTAI_RUNTIME_MASTER_STATE_V2_5.md`
...
## Source: `docs/runtime/architecture/CORTAI_SYSTEM_ARCHITECTURE_BIBLE.md`
