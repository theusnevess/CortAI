...
$eventHits = @{
    ...
    "CONTENT/publish_started" = (rg -n "CONTENT/publish_started" tests backend/app | Measure-Object -Line).Lines
    "CONTENT/publish_completed" = (rg -n "CONTENT/publish_completed" tests backend/app | Measure-Object -Line).Lines
