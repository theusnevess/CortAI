    ...
    def generate_structured(self, request):  # noqa: ANN001
        ...
        return ScriptGenerationResponse(
            script_plan=ScriptPlan(
                hook="The old station announced a train at midnight.",
                setup="Staff swore the speakers lost power years ago.",
                payoff="The platform display named a city never built.",
