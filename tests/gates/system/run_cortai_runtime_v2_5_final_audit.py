...
def _run_tests() -> list[dict[str, Any]]:
    test_files = [
        ...
        "tests/attribution/test_content_attribution_d8_unittest.py",
        "tests/attribution/test_content_attribution_phase_a_canonicalization_unittest.py",
        "tests/attribution/test_content_attribution_phase_b_contract_unittest.py",
        "tests/attribution/test_content_attribution_phase_c_experiment_aware_unittest.py",
        ...
        "tests/runtime/events/test_window_post_pipeline_d10_unittest.py",
...
def main() -> None:
    ...
    master_state_text = (ROOT / "docs" / "runtime" / "architecture" / "CORTAI_RUNTIME_MASTER_STATE_V2_5.md").read_text(encoding="utf-8")
    ...
    block_a = {
        "passed": all(
            [
                ...
                _exists(ROOT / "docs" / "runtime" / "architecture" / "CORTAI_RUNTIME_MASTER_STATE_V2_5.md"),
