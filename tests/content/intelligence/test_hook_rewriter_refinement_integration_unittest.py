...
class HookRewriterRefinementIntegrationTests(unittest.TestCase):
    def setUp(self) -> None:
    ...
    def test_flag_off_matches_baseline(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            service.execute(
                ExecutionEnvelope(
                    job_id="job_hook_refinement_off",
                    account_id="acc_1",
                ...
                script_text=(
                    "A recovered tape mentioned hospital wing sealed after 3 AM. "
            ...
            self.assertIn("A RECOVERED TAPE MENTIONED HOSPITAL WING 3 AM.", adapter.last_script_text or "")

    def test_flag_on_preserves_provenance_in_runtime_text(self) -> None:
