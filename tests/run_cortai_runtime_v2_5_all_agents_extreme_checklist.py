...
def _load_artifacts() -> dict[str, Any]:
    ...
    artifacts["master_state_text"] = (ROOT / "docs" / "runtime" / "CORTAI_RUNTIME_MASTER_STATE_V2_5.md").read_text(
        encoding="utf-8"
    )
    return artifacts
...
def _run_canonical_tests() -> list[dict[str, Any]]:
    test_files = [
        ...
        "tests/test_script_generation_unittest.py",
        ...
        "tests/test_editor_interpreter_unittest.py",
